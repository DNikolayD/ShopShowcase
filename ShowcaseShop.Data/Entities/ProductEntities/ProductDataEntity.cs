...
namespace ShowcaseShop.Data.Entities.ProductEntities
{
    public class ProductDataEntity : BaseDataEntity<string>
    {
        ...
        {
            Images = new List<ShowcaseProjectShop.Data.Entities.ProductDataEntities.ImageDataEntity>();
            Sales = new List<SaleDataEntity>();
            Categories = new List<ShowcaseProjectShop.Data.Entities.ProductDataEntities.CategoriesDataEntity>();
        }
        ...
        public List<ShowcaseProjectShop.Data.Entities.ProductDataEntities.ImageDataEntity> Images { get; set; }

        public List<SaleDataEntity> Sales { get; set; }

        public List<ShowcaseProjectShop.Data.Entities.ProductDataEntities.CategoriesDataEntity> Categories { get; set; }
    }
}
